...
<head>
  ...
  <script src="js/admin-script.js"> </script>  
   <script src="js/admin-trails.js"> </script>
  <!-- <script src="js/admin-script.js"> </script> -->
          ...
          <div class="box box-primary">
            ...
            <div class="box-body no-padding">				  
                ...
                <div class="input-group col-xs-3">
                  ...
                  <input onchange="changeTrail();" type="text" class="form-control pull-right" id="trail">
                </div>
                <!-- /.input group -->
              </div>	
				<!--<div class="form-group" style="display:block;" align="center">
              ...
              <div class="table-responsive mousescroll" style=" height:225px; overflow-y:scroll; ">
                <table class="table table-hover table-striped" >
				  <thead style="background-color:#e9f0f5; ">
					<tr>						
						<th class='col-xs-3' style="text-align:center;"><b>Employee Name</b></th>
						<th style="text-align:center;"><b>Employee Role</b> </th>
            <th style="text-align:center;"><b>Date</b> </th>
            <th style="text-align:center;"><b>Action</b> </th>
					 </tr>
				  </thead>
                  <tbody id="trail-table" style="text-align:center;">
