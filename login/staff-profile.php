        ...
        <ul class="nav navbar-nav">
          <li class="dropdown messages-menu">            
           <ul class="dropdown-menu">
              ...
              <li class="footer"><a href="#" onclick='location.href="staff-pending-orders.php"; return false;'>See All Messages</a></li>
            </ul>
          </li>
    ...
    <li>
      ...
      <li><a href="staff-foods.php"><i class="fa fa-circle-o"></i> Foods</a></li>           
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
      <li><a href="staff-tables.php"><i class="fa fa-circle-o"></i> Tables </a></li>
          </ul>
        </li>
